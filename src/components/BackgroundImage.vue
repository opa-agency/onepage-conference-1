<template>
  <div class="absolute inset-0 overflow-hidden bg-indigo-50" v-bind="$attrs">
    <img
      :class="imageClasses"
      :src="backgroundImage"
      alt=""
      ...
      height="1495"
    />
    <div class="absolute inset-x-0 top-0 h-40 bg-linear-to-b from-white" />
    <div class="absolute inset-x-0 bottom-0 h-40 bg-linear-to-t from-white" />
  </div>
</template>
